> **v3 note:** this is v2's rulebook, copied with the backend. Its rules about the server,
> data and overlays still hold. Its sections on Electron and the HTML operator pages describe
> what v3 is replacing; see `../CLAUDE.md` and `../docs/PLAN.md` for v3.
