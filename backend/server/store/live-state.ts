...
// Writes the state now instead of waiting out saveStateSoon's debounce.
// Called on shutdown (server/lifecycle.ts): without it, the last change made in the
// 150 ms before the desktop app closes would be lost.
