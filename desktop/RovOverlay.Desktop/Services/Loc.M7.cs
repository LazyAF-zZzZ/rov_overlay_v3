...
public sealed partial class Loc
{
    private static readonly Dictionary<string, string> M7En = new()
    {
        ...
        ["Update.Later"] = "Later",
        ["Update.LaterNote"] = "Later costs nothing: it goes in by itself the next time you close the app.",
    ...
    private static readonly Dictionary<string, string> M7Th = new()
    {
        ...
        ["Update.LaterNote"] = "กดไว้ก่อนได้ ไม่เสียอะไร เดี๋ยวจะติดตั้งให้เองตอนคุณปิดแอปครั้งถัดไป",
